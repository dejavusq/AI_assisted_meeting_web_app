...
| Speech-to-Text | [腾讯云语音识别 SDK](https://github.com/TencentCloud/tencentcloud-speech-sdk-js) |
...
Open `meetingPro_dejavu_v1.html` in your browser, or serve it with any static file server:
...
├── 腾讯云语音识别配置指南.md              # Tencent Cloud ASR setup guide
├── LICENSE
└── README.md
```
...
- [腾讯云语音识别 SDK](https://github.com/TencentCloud/tencentcloud-speech-sdk-js) - 提供实时语音转录能力
...
1. 用浏览器打开 `meetingPro_dejavu_v1.html`
...
| 语音识别 | [腾讯云语音识别 SDK](https://github.com/TencentCloud/tencentcloud-speech-sdk-js) |
